  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved piece as @piece" do
        ...
        post :create, {:piece => { "gallery_id" => "invalid value" }}, valid_session
        assigns(:piece).should be_a_new(Piece)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested piece" do
        ...
        Piece.any_instance.should_receive(:update).with({ "gallery_id" => "1" })
        put :update, {:id => piece.to_param, :piece => { "gallery_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the piece as @piece" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Piece.any_instance.stub(:save).and_return(false)
        put :update, {:id => piece.to_param, :piece => { "gallery_id" => "invalid value" }}, valid_session
        assigns(:piece).should eq(piece)
      end
